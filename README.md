...
<!-- ACTION NEEDED: add assets/logo.svg (120x120). Delete this img tag if you skip a logo. -->
<img src="assets/logo.svg" alt="PDF to MD Converter logo" width="120" />
...
[![Issues](https://img.shields.io/github/issues/ajith2189/PDF_to_MD_Converter?style=flat-square)](https://github.com/ajith2189/PDF_to_MD_Converter/issues)
[![Last Commit](https://img.shields.io/github/last-commit/ajith2189/PDF_to_MD_Converter?style=flat-square)](https://github.com/ajith2189/PDF_to_MD_Converter/commits)
[![Repo Size](https://img.shields.io/github/repo-size/ajith2189/PDF_to_MD_Converter?style=flat-square)](https://github.com/ajith2189/PDF_to_MD_Converter)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen?style=flat-square)](CONTRIBUTING.md)

<!-- ACTION NEEDED: add assets/demo.gif -->
<img src="assets/demo.gif" alt="PDF to MD Converter demo" width="720" />
...
**PDF to MD Converter** is a Google Colab notebook that converts batches of scientific PDFs into structured Markdown suitable for RAG pipelines, LLM fine-tuning corpora, literature reviews, and note systems like Obsidian.
...
> [!NOTE]
> PDF to MD Converter is a **notebook, not a library**. It is designed to be opened in Colab, run top to bottom, and produce a downloadable ZIP. There is no `pip install`.
...
| Problem | Typical tool behaviour | PDF to MD Converter |
|---|---|---|
...
<!-- ACTION NEEDED: capture these four screenshots into assets/ -->
...
The notebook sidesteps this by submitting `CHUNK_SIZE` documents per invocation. Empirically, 1–4 PDFs succeed reliably on a T4 and 5+ fail. The default of 3 leaves headroom for papers exceeding 60 pages.
...
<!-- ACTION NEEDED: fill in from your own runs -->
...
<!-- ACTION NEEDED: create these two files, or delete the line below -->
...
<!-- ACTION NEEDED: pick a license, add LICENSE file, edit line below -->
...
<!-- ACTION NEEDED: replace YOURPROFILE and the email address -->
...
💡 **Request features** via [Issues](https://github.com/ajith2189/PDF_to_MD_Converter/issues)
🔀 **Open a pull request**
